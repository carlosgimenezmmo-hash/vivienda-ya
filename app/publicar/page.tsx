            ...
            <div style={{
              ...
              <div>
                <p style={{ margin: 0, fontSize: 13, fontWeight: 600, color: gpsStatus === "ok" ? "#22C55E" : gpsStatus === "error" ? "#FCA5A5" : "#60A5FA" }}>
                  {gpsStatus === "ok" ? "ARRYSE: Ubicación capturada ✓" : gpsStatus === "error" ? "ARRYSE: No se pudo obtener GPS" : "ARRYSE: Capturando ubicación..."}
                </p>
                {location && <p style={{ margin: 0, fontSize: 11, color: "rgba(255,255,255,0.3)" }}>{location.lat.toFixed(4)}, {location.lng.toFixed(4)}</p>}
              </div>
            </div>
            ...
            {!video ? (
              <div>
                <div onClick={() => videoInputRef.current?.click()} style={{
                  ...
                  <p style={{ margin: 0, fontWeight: 700, fontSize: 17 }}>Tocá para grabar</p>
                  <p style={{ margin: "6px 0 0", fontSize: 13, color: "rgba(255,255,255,0.35)" }}>Se abre la cámara · {duracionElegida} seg máximo</p>
                </div>
              ...
              <div>
                ...
                <button onClick={() => { setVideo(null); setVideoPreview(null) }} style={{ ...btn, background: "rgba(255,255,255,0.06)", boxShadow: "none", color: "rgba(255,255,255,0.6)", marginBottom: 10, fontSize: 14 }}>
                  Volver a grabar
                </button>
