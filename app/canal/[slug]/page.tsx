...
export default function CanalPage() {
  ...
  return (
    <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "#0a0a0a", color: "#fff", fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif", overflowY: "scroll" } as React.CSSProperties}>
      ...
      {/* PANEL DETALLE */}
      {propActiva && (
        <div style={{ position: "fixed", inset: 0, zIndex: 50, display: "flex", flexDirection: "column", justifyContent: "flex-end" }} onClick={() => setPropActiva(null)}>
          <div style={{ background: "#1a1a1a", borderRadius: "24px 24px 0 0", padding: "20px 20px 48px", width: "100%", height: "70vh", overflowY: "scroll" } as React.CSSProperties} onClick={e => e.stopPropagation()}>
