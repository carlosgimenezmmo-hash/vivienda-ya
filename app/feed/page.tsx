          ...
          properties.map((p, i) => (
            <section key={p.id} style={{ height: '100dvh', scrollSnapAlign: 'start', position: 'relative', overflow: 'hidden', background: '#000' }}>
              ...
              <div style={{ position: 'absolute', bottom: 90, left: 16, right: 80, zIndex: 25, color: '#fff' }}>
                ...
                <p onClick={() => setShowDetails(showDetails === p.id ? null : p.id)} style={{ margin: '8px 0 0 0', fontSize: 20, color: '#22C55E', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 4 }}>
