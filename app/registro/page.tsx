...
Plan GRATIS ($0): 3 videos activos/mes · 60 seg/video · Estadísticas básicas · Chat · Verificación ARRYSE incluida.

Plan PRO (USD 1,50/semana): 15 videos activos/mes · 60 seg/video · Estadísticas avanzadas · Ver quién vio tus propiedades · Badge PRO · 1 destacado/semana · Soporte prioritario · 7 días de prueba gratis.

Plan INMOBILIARIA PREMIUM (USD 25/mes): 50 videos/mes · hasta 5 min/video · 5 agentes · 5 destacados/mes · 2 lives/mes · API · Carga masiva · Badge INMOBILIARIA VERIFICADA · Soporte VIP.

Plan INMOBILIARIA PLUS (USD 40/mes): 100 videos/mes · hasta 5 min/video · 10 agentes · 10 destacados/mes · 4 lives/mes · Prioridad absoluta en búsquedas.

Comisión alquileres temporarios: 10% sobre el valor total de la reserva, descontada automáticamente.

Medios de pago: Visa, Mastercard, Amex, Cabal, débito, MercadoPago, transferencia bancaria (montos > USD 100). Precios en USD; pagos en ARS al tipo de cambio vendedor Banco Nación más impuestos aplicables.

Renovación automática. Sin reembolso por cancelación anticipada, salvo Ley 24.240.

4. SISTEMA ARRYSE (VERIFICACIÓN GEOLOCALIZADA)
ARRYSE verifica que el video fue grabado en el lugar declarado mediante GPS, altitud, acelerómetro y metadatos nativos. Es gratuito, automático e inmediato.

ARRYSE NO garantiza titularidad del inmueble, ausencia de deudas, gravámenes ni estado legal del bien. Limitaciones: 1 verificación cada 500m, 1 cada 24 horas. Prohibido importar videos externos.

5. PUBLICACIONES Y CONTENIDO
El usuario es exclusivo responsable del contenido publicado. Garantiza que la información es veraz, vigente y que tiene derecho a publicarla. Está prohibido publicar propiedades inexistentes, datos falsos, spam o contenido engañoso. Las publicaciones tienen vigencia de 30 días. La plataforma puede eliminar publicaciones que violen estos términos.

6. RESPONSABILIDAD Y ROL DE LA PLATAFORMA
VIVIENDA YA ACTÚA COMO INTERMEDIARIO TECNOLÓGICO. NO ES PARTE EN NINGUNA OPERACIÓN INMOBILIARIA Y NO ASUME RESPONSABILIDAD ALGUNA POR LOS BIENES PUBLICADOS, LAS PARTES INVOLUCRADAS NI LOS DAÑOS QUE PUDIERAN DERIVARSE DE LAS OPERACIONES CONCERTADAS A TRAVÉS DE LA PLATAFORMA.

La responsabilidad máxima de la plataforma se limita al monto pagado por el usuario en los últimos 12 meses o USD 10, el que sea mayor. El usuario se compromete a mantener indemne a la plataforma frente a cualquier reclamo de terceros.

Se recomienda realizar la debida diligencia antes de cualquier operación. Para reportar irregularidades: denuncias@viviendaya.com o botón DENUNCIAR en la publicación.

7. PERMUTAS
La plataforma facilita el contacto entre usuarios que desean permutar propiedades. VIVIENDA YA no interviene, representa ni garantiza ninguna permuta. La responsabilidad es exclusiva de las partes.

8. ALQUILER TEMPORARIO (MODO AIRBNB)
Estadías de 1 noche a 3 meses. El propietario es responsable del calendario de disponibilidad. El pago se libera 24 horas post check-in. Las reseñas son públicas y no eliminables. Comisión del 10% sobre el valor total de la reserva.

9. PROPIEDAD INTELECTUAL
La marca, código, diseño y algoritmos de Vivienda Ya son propiedad exclusiva de [Nombre de la Empresa]. Se otorga al usuario una licencia de uso limitada, no exclusiva e intransferible. Está prohibida la reproducción, ingeniería inversa o uso no autorizado. El contenido publicado por el usuario otorga a la plataforma una licencia gratuita para su uso dentro del servicio.

10. SUSPENSIÓN Y BAJA DE CUENTAS
La plataforma puede suspender cuentas por incumplimiento, fraude o conductas abusivas. El usuario puede solicitar la baja desde "Mi perfil" o escribiendo a bajas@viviendaya.com. La baja implica pérdida de acceso, publicaciones y beneficios. Los datos se conservan 2 años post-baja.

11. MODIFICACIONES
La plataforma puede modificar estos Términos notificando con 10 días de antelación. El uso continuado implica aceptación tácita. El usuario puede oponerse dando de baja su cuenta.

12. JURISDICCIÓN
Ley aplicable: República Argentina. Jurisdicción: Tribunales Ordinarios de la Ciudad Autónoma de Buenos Aires. Domicilio de la empresa: [Dirección completa], CABA.

13. NOTIFICACIONES
- Consultas: info@viviendaya.com
- Legal: legal@viviendaya.com
- Datos personales: protecciondedatos@viviendaya.com
- Denuncias: denuncias@viviendaya.com
- Bajas: bajas@viviendaya.com
- Atención: atencion@viviendaya.com
Plazo de respuesta: 10 días hábiles (Ley 24.240).

14. VIGENCIA
Estos Términos rigen por tiempo indeterminado desde la fecha de aceptación por parte del usuario.`
...
export default function RegistroPage() {
  ...
  <div style={{ display: 'flex', gap: 8 }}>
    ...
    />
        ...
        {step === 3 && (
          <div>
            <h1 style={{ fontSize: 26, fontWeight: 800, margin: '0 0 6px', letterSpacing: -0.5 }}>Verificá tu identidad</h1>
            ...
            <div style={{ background: 'rgba(37,99,235,0.1)', border: '1px solid rgba(37,99,235,0.25)', borderRadius: 10, padding: '10px 14px', marginBottom: 24 }}>
              <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 12, margin: 0 }}>🔒 Tus datos están protegidos. Solo se usan para verificar tu identidad (Ley 25.326)</p>
            </div>
                ...
                <div key={side}>
                  ...
                  <div onClick={() => handleScanDNI(side)} style={{
                    ...
                    {scanning && scanSide === side ? (
                      ...
                      <>
                        <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.25)" strokeWidth="1.5"><rect x="3" y="5" width="18" height="14" rx="2"/><circle cx="8.5" cy="10.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg>
                        <p style={{ color: 'rgba(255,255,255,0.25)', fontSize: 13, marginTop: 8 }}>Tocá para fotografiar</p>
                      </>
                    )}
                  </div>
                </div>
        ...
        {step === 4 && (
          <div style={{ textAlign: 'center', paddingTop: 16 }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: 15, margin: '0 0 8px', lineHeight: 1.6 }}>
              Tu cuenta está siendo verificada.<br/>Esto puede tardar hasta 24 horas.
            </p>
            ...
            <button onClick={handleRegistro} disabled={loading || !aceptaTyC} style={{ ...btn, marginTop: 20, opacity: (loading || !aceptaTyC) ? 0.5 : 1, cursor: !aceptaTyC ? 'not-allowed' : 'pointer' }}>
